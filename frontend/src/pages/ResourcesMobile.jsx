          ...
          <div className="relative z-10 w-full flex flex-col items-center px-4">
            ...
            {showPdfModal && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" onClick={() => setShowPdfModal(false)}>
                <div className="bg-white rounded-2xl shadow-xl p-2 w-full max-w-sm relative animate-fadeIn border border-gray-100 flex flex-col" onClick={e => e.stopPropagation()}>
                  ...
                  <iframe src={activeResource.url.startsWith('/resources/') ? `${window.location.origin}${activeResource.url}` : activeResource.url} title="E-book PDF" width="100%" height="400px" style={{border:0}}></iframe>
                </div>
              </div>
            )}
          </div>
